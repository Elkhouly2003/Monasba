  ...
  return (
    <div className="min-h-screen bg-light-neutral">
      ...
      <div className="flex justify-center items-center mt-32">
        {!isEmailSent && (
          <div className="rounded-3xl px-4 py-8 text-center bg-dark-navy w-full max-w-md">
            <h4 className="mb-2 text-3xl text-light-neutral font-semibold">
              {" "}
              Reset Password
            </h4>
            <p className="mb-4 text-light-neutral text-xl">Enter your email </p>
            <form onSubmit={onSubmitEmail}>
              <div className="mt-10 mb-4 bg-steel-blue border border-state-blue rounded-xl flex text-light-neutral items-center px-3 py-2">
                <span className="text-gray-500">
                  <i className="bi bi-envelope"></i>
                </span>
                <input
                  type="email"
                  className="border-0 px-2 py-3 w-full focus:ring-0 focus:outline-none bg-steel-blue  "
              ...
              <button
                type="submit"
                className="cursor-pointer bg-state-blue hover:bg-cool-gray/50 text-light-neutral w-full py-3 rounded-lg font-semibold disabled:bg-gray-400 disabled:cursor-not-allowed"
                disabled={loading}
              >
        ...
        {!isOtpSubmitted && isEmailSent && (
          <div className="p-5 rounded-3xl shadow-lg bg-white w-96">
            ...
            <button
              className="bg-blue-600 text-white w-full py-2 rounded-lg font-semibold hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
              disabled={loading}
          ...
          <div className="rounded-3xl p-5 text-center bg-white w-full max-w-sm">
            ...
            <form onSubmit={onSubmitNewPassword}>
              <div className="mb-4 bg-gray-100 rounded-full flex items-center px-3 py-2">
                ...
                <input
                  type="password"
                  className="bg-transparent border-0 px-2 py-2 w-full focus:outline-none"
                  placeholder="••••••••"
